...
const BenefitCard = ({ icon: Icon, title, description }) => {
  return (
    ...
    >
      ...
      <h3 className="text-lg font-bold text-font mb-2">{title}</h3>
    ...
    institution: [
      {
        ...
        description: "Complement your curriculum with industry-relevant technical workshops"
      },
      {
        icon: Users,
        title: "Industry Connections",
        description: "Build relationships with tech companies through our partner network"
      },
      {
        icon: Award,
        title: "Improved Placement Records",
        description: "Better prepare students for job market with practical skills"
      }
    ],
    students: [
      {
        ...
        description: "Work on real projects using industry-standard tools and technologies"
      },
      {
        icon: Briefcase,
      ...
      },
      {
        ...
        description: "Build impressive projects to showcase to potential employers"
      }
    ],
    faculty: [
      {
        ...
        description: "Stay updated with latest industry trends and technologies"
      },
      {
        icon: Target,
      ...
      },
      {
        ...
        description: "Bridge the gap between academia and industry requirements"
      }
    ]
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Delivering value to institutions, students, and faculty through industry-aligned technical training
          </p>
        </div>
        ...
        <div className="space-y-16">
          {/* For Institutions */}
          <div>
            <h3 className="text-2xl font-bold text-font mb-6 text-center">
              For Institutions
            </h3>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-font mb-6">
