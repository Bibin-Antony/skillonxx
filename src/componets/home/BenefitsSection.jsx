...
import { Clock, Globe, Laptop, Code, Users, Briefcase, Award, Zap, ArrowRight, ChevronRight, Sparkles, Gem, Shield, Target } from 'lucide-react';

const benefits = [
  {
    title: "Flexible Learning",
    description: "Master tech skills at your own pace, with 24/7 access to course content and personalized learning paths.",
    icon: Clock,
  ...
  },
  {
    ...
    description: "Join a vibrant community of learners from 150+ countries, sharing knowledge and opportunities.",
    icon: Globe,
  ...
  },
  {
    ...
    description: "Access courses on any device with our adaptive learning platform and offline content support.",
    icon: Laptop,
  ...
  },
  {
    ...
    description: "Learn from curriculum designed by tech leaders from top companies, updated quarterly.",
    icon: Code,
  ...
  },
  {
    ...
    description: "Build your portfolio with 100+ hands-on projects and real-world collaborative challenges.",
    icon: Users,
  ...
  },
  {
    ...
    description: "85% of our graduates report career growth within 6 months of completing their courses.",
    icon: Briefcase,
  ...
  },
  {
    ...
    description: "Earn certificates valued by top tech companies, with blockchain-verified credentials.",
    icon: Award,
  ...
  },
  {
    ...
    description: "Stay ahead with courses on emerging tech, from AI and blockchain to cloud computing.",
    icon: Zap,
...
const BackgroundElements = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    {[...Array(6)].map((_, i) => (
      ...
      >
        {i % 3 === 0 ? <Sparkles className="w-6 h-6 text-blue-200/20" /> :
         i % 3 === 1 ? <Gem className="w-6 h-6 text-purple-200/20" /> :
...
const BenefitCard = ({ benefit, index }) => (
  <div className="group relative">
    ...
    <div className="h-full bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100/50">
      {/* Icon */}
      <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${benefit.color} p-3 mb-6 flex-shrink-0 relative group-hover:scale-110 transition-transform duration-300`}>
