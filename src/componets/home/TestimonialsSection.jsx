...
import { ChevronLeft, ChevronRight, Star, Quote, Users, MessageCircle, Heart, Award } from 'lucide-react';
...
const testimonials = [
  {
    ...
    quote: "SkillonX's web development bootcamp was a game-changer for my career. The hands-on projects and expert instructors helped me land my dream job within months of graduating.",
    rating: 5,
  ...
  },
  {
    ...
    company: "Microsoft",
    image: "/api/placeholder/150/150",
    quote: "The data science course on SkillonX is top-notch. The curriculum is comprehensive and up-to-date with industry standards. It gave me the skills to transition into a data-driven role.",
    rating: 5,
  ...
  },
  {
    ...
    company: "Apple",
    image: "/api/placeholder/150/150",
    quote: "SkillonX's design courses are incredible. I've improved my UX skills, learned the latest design tools, and even started freelancing - all thanks to what I've learned here!",
    rating: 5,
...
const TestimonialCard = ({ testimonial, isActive }) => (
  <div className={`relative h-full transform transition-all duration-500 ${isActive ? 'scale-100 opacity-100' : 'scale-95 opacity-50'}`}>
    {/* Card Background with Gradient */}
    <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100/50">
