...
const steps = [
  {
    ...
    description: "Browse our diverse range of cutting-edge tech courses and programs. Find the perfect path for your career goals.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description: "Access expert-led lessons and structured learning paths. Learn at your own pace with interactive content.",
    icon: Play,
  ...
  },
  {
    ...
    description: "Work on real-world projects and build a professional portfolio. Practice with hands-on coding assignments.",
    icon: Code,
  ...
  },
  {
    ...
    description: "Complete assessments and earn recognized certificates. Validate your skills with industry-standard certifications.",
    icon: Award,
  ...
  },
  {
    ...
    description: "Connect with peers, participate in hackathons, and join tech forums. Build your professional network.",
    icon: Users,
  ...
  },
  {
    ...
    description: "Apply your skills in a guaranteed 3-month internship. Work on real projects with industry partners.",
    icon: Coffee,
  ...
  },
  {
    ...
    description: "Receive personalized mentorship and job search assistance. Attend exclusive industry networking events.",
    icon: Network,
  ...
  },
  {
    ...
    description: "Transform your career with your new skills and experience. Join our successful alumni network.",
    icon: Briefcase,
...
const BackgroundElements = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    {[...Array(8)].map((_, i) => (
      ...
      >
        {i % 4 === 0 ? <Laptop className="w-8 h-8 text-blue-200/20" /> :
         i % 4 === 1 ? <Hexagon className="w-8 h-8 text-purple-200/20" /> :
         i % 4 === 2 ? <Database className="w-8 h-8 text-green-200/20" /> :
...
const StepCard = ({ step, index, isLast }) => (
  <div className="group relative h-full">
    ...
    <div className="h-full flex flex-col bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:translate-x-2 border border-gray-100/50">
      ...
      {/* Icon */}
      <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${step.color} p-3 mb-6 flex-shrink-0 relative group-hover:scale-110 transition-transform duration-300`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 relative">
          ...
          <p className="relative text-gray-600 text-lg">
            Follow our proven pathway to transform your career in technology, supported every step of the way.
          </p>
        </div>
        ...
        <div className="mt-20 text-center relative">
          ...
          <p className="mt-4 text-gray-500 relative">
            Join 10,000+ students who have transformed their careers with SkillonX
          </p>
        </div>
      </div>
